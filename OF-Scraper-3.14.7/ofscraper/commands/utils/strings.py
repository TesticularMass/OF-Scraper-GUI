...
area_str = r"Getting \[[bold deep_sky_blue2]{areas}[/bold deep_sky_blue2]] for [bold]{name}[/bold]"
...
all_paid_progress_download_str = (
    r"\[{model_id}_{username}] Downloading Progress :{count}/{length} models"
)

all_paid_progress_metadata_str = (
    r"\[{model_id}_{username}] Metadata Update Progress :{count}/{length} models"
)
